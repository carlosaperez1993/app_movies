...
class FavoriteViewHolder(itemView: View, movieDetail: ClickMovieDetail) : BaseViewHolder<FavMovie>(
    itemView
) {
    ...
    override fun bind(data: FavMovie) {
        //bindings
        this.movie = data
    ...
    override fun onClick(v: View?) {
        super.onClick(v)
        clickMovieDetail.onTap(Movie(movieId = movie.movieId))
    }
